...
def LoadCalibResult(calibFilename):
    fs = cv2.FileStorage(calibFilename,cv2.FILE_STORAGE_READ)
...
start = time.time()
disparityImg, leftImgRectified, perspectiveMatrix = StereoMatchingWithCalibFiles(leftImg, rightImg, "A01-A02_l.yml", "A01-A02_r.yml")
